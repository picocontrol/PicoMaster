        <!-- When font awesome is being loaded corretly, then delete this <- Run test -->
     ...
     <h1>Share Buttons</h1>
        ...
        <!-- Twitter -->
        <a href="http://twitter.com/share?url=<URL>&text=<TEXT>&via=<VIA>" target="_blank" class="btn share-btn twitter"><i class="fa fa-twitter"></i></a><!-- Google Plus --><a href="https://plus.google.com/share?url=<BTN>" target="_blank" class="btn share-btn google-plus">
